...
function test() {
 ...
 function myFunction() {
        ...
        document.write("<br /><br /><br /><br /><br /><br /><br /><center><FONT SIZE=52><FONT COLOR='#000000'>" +
           r_text[i]  + "</FONT></center><br /> ");
        document.write("<br /><br /><br /><br /><br /><center><FONT SIZE=52><FONT COLOR='#000000'>" +
           "Accuracy of our proposed model is <b> 92.24% </b>" + "</FONT></center><br /> ");
        var bgcolorlist=new Array("#abbfb6", "#ffd9cc","#ffbdbd","#f1cbff","#a3b3e1","#899ad6","#93c47d","#ffd966","#ea9999")
